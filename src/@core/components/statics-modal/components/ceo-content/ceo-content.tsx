       ...
       <div style="font-family: 'Inter', sans-serif; color: #333; line-height: 1.6;">
        ...
        <div class="space-y-2">
          <p style="font-size: 16px;">
            <strong style="color: #555;">💰 Kirimlar:</strong> <span style="color: #28a745;">${soffBotText.income} so'm</span>
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">👥 Kelmagan o'quvchilar soni:</strong> <span style="color: #dc3545;">${soffBotText.absent_students} ta</span>
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">👥 Davomat qilinmagan o'quvchilar soni:</strong> <span style="color: #dc3545;">${soffBotText.missed_attendance || 0} ta</span> <br/>
            ${soffBotText.missed_attendance > 0 ? missedStudentsText : ''}
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">✨ Yangi qo'shilgan lidlar:</strong> <span style="color: #17a2b8;">${soffBotText.new_leads} ta</span>
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">❌ Bog'lanilmagan lidlar:</strong> <span style="color: #ffc107;">${soffBotText.unconnected_leads} ta</span>
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">🧑‍🎓 Yangi kelgan o'quvchilar:</strong> <span style="color: #0077FF;">${soffBotText.added_students} ta</span>
          </p>
          
          <p style="font-size: 16px;">
            <strong style="color: #555;">🧑‍🎓 Ketkan o'quvchilar:</strong> <span style="color: #0077FF;">${soffBotText.left_students} ta</span>
          </p>
