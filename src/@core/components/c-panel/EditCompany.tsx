            ...
            >
                ...
                >
                    ...
                    <Box sx={{
                        ...
                        <Typography sx={{ fontSize: '20px', borderBottom: '1px solid white', marginBottom: '20px' }}>{t("O'quv markaz tahrirlash uchun quyidagi ma'lumotlarni to'ldiring")}</Typography>
