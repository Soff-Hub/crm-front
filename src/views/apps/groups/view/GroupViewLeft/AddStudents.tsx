  ...
  return (
    ...
    >
      ...
      {!!formik.errors.student && formik.touched.student && (
        <FormHelperText sx={{ textAlign: 'center', fontSize: '15px' }} error>
        ...
        <form style={{ marginTop: 10 }} onSubmit={formik.handleSubmit}>
          ...
          <DialogActions sx={{ justifyContent: 'center' }}>
            ...
            <Button
              ...
              color='secondary'
              onClick={() => (
                dispatch(handleEditClickOpen(null)), setSelectedStudents(null), formik.resetForm(),setLoading(false) ,setIsDiscount(false)
              )}
            >
              {t('Bekor Qilish')}
            </Button>
