...
export default function SentSMS({ id, modalRef, setModalRef }: { id: string, modalRef: string | null, setModalRef: any }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setLoading(true)
            try {
                const response = await api.post('common/send-message-user/', { user: id, ...values })
