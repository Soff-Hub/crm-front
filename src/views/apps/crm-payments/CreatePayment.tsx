...
export default function CreatePayment() {
  ...
  const { isOpenClientModal, clientSideTariffs } = useAppSelector(state => state.cPanelSlice)
        ...
        <Box width={'100%'}>
          ...
          >
            <FormControl fullWidth>
              ...
              <FormHelperText error={!!formik.errors.tariff && !!formik.touched.tariff}>
                {!!formik.errors.tariff && !!formik.touched.tariff && formik.errors.tariff}
              </FormHelperText>
            </FormControl>
