    ...
    return (
        <div>
            ...
            >
                ...
                <DialogContent>
                    {open ? <form onSubmit={handleSubmit} style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: '10px' }} id='edifsdt-employee-pay'>

                        {Number(openEdit?.amount) > 0 && <FormControl fullWidth>
                            <InputLabel
                                size='small'
                        ...
                        {Number(openEdit?.amount) > 0 && <FormControl sx={{ width: '100%' }}>
                            <input
                                type="date"
                                style={{ borderRadius: '8px', padding: '10px', outline: 'none', border: '1px solid gray', marginTop: '10px' }}
                                name='payment_date'
                                value={values.payment_date}
                                onChange={handleChange}
                                onBlur={handleBlur}
                            />
                            {!!errors.payment_date && touched.payment_date && <FormHelperText error>{errors.payment_date}</FormHelperText>}
                        </FormControl>}
