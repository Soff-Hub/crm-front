    ...
    },
    {
      ...
      renderId: (id, bonus_amount) => (
        <input
          ...
          type='string'
          value={+bonus_amount}
          onChange={e => dispatch(updateSalaryBonus({ id, bonus_amount: Number(e.target.value) || 0 }))}
        />
      )
    },
    {
      ...
      renderId: (id, fine_amount) => (
        <input
          ...
          type='string'
          value={+fine_amount}
          onChange={e => dispatch(updateSalaryFine({ id, fine_amount: Number(e.target.value) || 0 }))}
        />
      )
    },
    {
    ...
    <div>
      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        ...
        <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: '10px', maxWidth: '350px' }}>
          ...
          <Typography sx={{ textAlign: 'center', marginBottom: '20px', color: 'orange' }}>
